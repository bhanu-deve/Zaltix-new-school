...
//     try {
//       if (editingId) {
//         await api.put(`/AddTest/${editingId}`, data);
//         toast.success('✅ Test updated successfully');
//       } else {
//         await api.post(`/AddTest`, { ...data, status: 'Draft', attempts: 0 });
...
//       await api.put(`/AddTest/${id}`, { ...current, status: newStatus });
