// // src/pages/principal/Holidays.tsx
...
//       type: 'school',
//       description: 'Summer vacations begin'
//     }
//   ]);
...
//   useEffect(() => {
//     const savedHolidays = localStorage.getItem('principal-holidays');
//     if (savedHolidays) {
//       const parsed = JSON.parse(savedHolidays);
//       // Convert date strings back to Date objects
//       const holidaysWithDates = parsed.map((holiday: any) => ({
//         ...holiday,
...
//   useEffect(() => {
//     localStorage.setItem('principal-holidays', JSON.stringify(holidays));
//   }, [holidays]);
...
//       holiday.id === editingId ? editData! : holiday
//     ));
//     setEditingId(null);
//     setEditData(null);
...
//                 Holidays will be visible to teachers, students, and parents in their calendars.
//               </AlertDescription>
//             </Alert>
//           </div>
...
//                     <p className="text-sm mt-2">Add holidays using the form on the left</p>
//                   </div>
//                 ) : (
...
//                                   value={editData.type}
//                                   onChange={(e) => setEditData({...editData, type: e.target.value as Holiday['type']})}
//                                 >
...
//                     .slice(0, 5)
//                     .map((holiday) => (
//                       <div key={holiday.id} className="flex items-center justify-between p-3 bg-white border rounded">
//                         <div>
...
//                   {sortedHolidays.filter(h => h.date >= new Date()).length === 0 && (
